					...
					<div className="row content align-items-center">
						<div className="col-lg-6 col-md-12 mb-lg-0 mb-5">
							<div className="pe-2">
								...
								<p className="pe-10 mb-5" data-aos="fade-zoom-in" data-aos-delay={200}>Let AI handle this part of your business—effortless, efficient, and optimized.</p>
								...
								<Link href="/page-register" className="ms-md-3 mt-3 mt-md-0 btn btn-outline-secondary hover-up" data-aos="fade-zoom-in" data-aos-delay={500}>
									View More
								</Link>
								<div className="row mt-8 mb-3">
									<h6 className="text-500 fs-5" data-aos="fade-zoom-in" data-aos-delay={100}>Over 3K marketers rely on us.</h6>
								</div>
								<div className="d-flex align-items-center">
									<div className="me-2" data-aos="fade-zoom-in" data-aos-delay={200}>
										...
										<span className="fs-6 fw-bold">4.8/5 <span className="text-secondary fw-medium">(3k Reviews)</span></span>
									</div>
