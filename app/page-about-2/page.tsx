							...
							<div className="col-lg-7 mx-lg-auto">
								<div className="text-center mb-lg-0 mb-5">
									<div className="d-flex align-items-center position-relative z-2 justify-content-center bg-linear-2 d-inline-flex rounded-pill border border-2 border-white px-3 py-1">
										...
										<span className="tag-spacing fs-7 fw-bold text-white ms-2 text-uppercase">About our company</span>
									</div>
							...
							<div className="col-lg-8">
								<div className="position-relative mb-lg-0 mb-8 fix">
									...
									<div className="position-absolute alltuchtopdown bottom-0 start-0 m-md-5 backdrop-filter rounded-4 px-7 py-4 text-center z-1">
										<p className="pt-2">Join thousands of  <br />successful sellers </p>
										...
										<div className="backdrop-filter bg-linear-2 rounded-4 px-6 py-4 z-1">
											<div className="d-flex align-items-center justify-content-between">
												<div className="my-lg-3 text-center">
													...
													<span className="h2 count fw-black my-0 lh-1 text-white text-nowrap">+<span className="odometer" /><CountUp end={50} enableScrollSpy={true} />k</span>
